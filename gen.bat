...
java org.apache.xalan.xslt.Process -EDUMP -text -in work\updatesite.xml -xsl stylesheet\%os_stylesheet%.xsl -out work\update.bat
if not errorlevel 0 goto fail
...
java org.apache.xalan.xslt.Process -EDUMP -text -in work\buildsite.xml -xsl stylesheet\%os_stylesheet%.xsl -out work\build.bat
if not errorlevel 0 goto fail
...
java org.apache.xalan.xslt.Process -EDUMP -text -in work\xrefsite.xml -xsl stylesheet\%os_stylesheet%.xsl -out work\xref.bat
if not errorlevel 0 goto fail

@REM ********************************************************************

echo Generate script to publish all xml source files
java org.apache.xalan.xslt.Process -text -in work\merge.xml -xsl stylesheet\%os_stylesheet%.xsl -out work\puball.bat
if not errorlevel 0 goto fail
...
java org.apache.xalan.xslt.Process -EDUMP -text -in work\pubsite.xml -xsl stylesheet\%os_stylesheet%.xsl -out work\publish.bat
if not errorlevel 0 goto fail
...
java org.apache.xalan.xslt.Process -text -in work\move.xml -xsl stylesheet\%os_stylesheet%.xsl -out work\move.bat
if not errorlevel 0 goto fail
