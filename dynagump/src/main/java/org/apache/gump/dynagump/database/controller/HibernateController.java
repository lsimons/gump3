...
import org.apache.gump.dynagump.database.hibernate.BuildHib;
import org.apache.gump.dynagump.database.hibernate.DependenciesHib;
import org.apache.gump.dynagump.database.hibernate.HibernateUtil;
import org.apache.gump.dynagump.database.hibernate.HostsHib;
import org.apache.gump.dynagump.database.hibernate.ProjectHib;
import org.apache.gump.dynagump.database.hibernate.ProjectVersionIdHib;
import org.apache.gump.dynagump.database.hibernate.RunsHib;
import org.apache.gump.dynagump.database.hibernate.WorkspaceHib;
import org.apache.gump.dynagump.valueObjects.Build;
import org.apache.gump.dynagump.valueObjects.HistoryVO;
...
import org.apache.gump.dynagump.valueObjects.WorkSpace;
...
public class HibernateController implements DBController {
    ...
    public void addHistory(Build b) throws SQLException {
        Session session = HibernateUtil.currentSession();
        ProjectHib ph = (ProjectHib) session.load(org.apache.gump.dynagump.database.hibernate.ProjectHib.class, b.getProjectId());
    ...
    public List<ProjectBuildVO> getProjectBuildsList(String projectID) throws SQLException {
        ...
        Session session = HibernateUtil.currentSession();
        ProjectHib ph = (ProjectHib) session.load(org.apache.gump.dynagump.database.hibernate.ProjectHib.class, projectID);
        Iterator<ProjectVersionIdHib> it = ph.getProjectVersion().iterator();
        while (it.hasNext()) {
